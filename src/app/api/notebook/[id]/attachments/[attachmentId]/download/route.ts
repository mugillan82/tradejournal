/**
 * Notebook Attachment Download Route
 *
 * GET /api/notebook/[id]/attachments/[attachmentId]/download
 */
...
import { getNotebookNoteAttachmentContent } from "@/lib/trading/attachment/service";
...
export async function GET(
  ...
  try {
    ...
    const { attachment, data, contentType } = await getNotebookNoteAttachmentContent(id, attachmentId);
