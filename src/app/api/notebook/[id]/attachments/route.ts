/**
 * Notebook Attachments API — List & Upload Route
 *
 * GET /api/notebook/[id]/attachments — List attachments for notebook note
 * POST /api/notebook/[id]/attachments — Upload new attachment for notebook note
 */
...
import {
  listNotebookNoteAttachments,
  uploadNotebookNoteAttachment,
...
export async function GET(
  ...
  try {
    ...
    const attachments = await listNotebookNoteAttachments(id);
...
export async function POST(
  ...
  try {
    ...
    const attachment = await uploadNotebookNoteAttachment(id, {
      fileName,
      mimeType,
      buffer,
    });
