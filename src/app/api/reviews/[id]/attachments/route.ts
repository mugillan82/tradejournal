/**
 * Review Attachments API — List & Upload Route
 *
 * GET /api/reviews/[id]/attachments — List attachments for review
 * POST /api/reviews/[id]/attachments — Upload new attachment for review
 */
...
export async function GET(
  ...
  try {
    ...
    const attachments = await listReviewAttachments(id);
...
export async function POST(
  ...
  try {
    ...
    const attachment = await uploadReviewAttachment(id, {
      fileName,
      mimeType,
      buffer,
    });
