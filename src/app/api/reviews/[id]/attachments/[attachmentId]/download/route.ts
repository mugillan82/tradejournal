/**
 * Review Attachment Download Route
 *
 * GET /api/reviews/[id]/attachments/[attachmentId]/download
 */
...
import { getReviewAttachmentContent } from "@/lib/trading/attachment/service";
...
export async function GET(
  ...
  try {
    ...
    const { attachment, data, contentType } = await getReviewAttachmentContent(id, attachmentId);
