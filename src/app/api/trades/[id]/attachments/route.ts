/**
 * Trade Attachments API — List & Upload Route
 *
 * GET /api/trades/[id]/attachments — List attachments for trade
 * POST /api/trades/[id]/attachments — Upload new attachment for trade
 */
...
// ---------------------------------------------------------------------------
// GET /api/trades/[id]/attachments — List attachments
// ---------------------------------------------------------------------------
...
export async function GET(
  ...
  try {
    ...
    const attachments = await listTradeAttachments(id);
...
// ---------------------------------------------------------------------------
// POST /api/trades/[id]/attachments — Upload attachment
// ---------------------------------------------------------------------------
...
export async function POST(
  ...
  try {
    ...
    const attachment = await uploadTradeAttachment(id, {
      fileName,
      mimeType,
      buffer,
    });
