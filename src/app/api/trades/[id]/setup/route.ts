/**
 * Trade Setup Association API
 *
 * PUT /api/trades/[id]/setup — Assign or clear setup on trade
 */
...
import { assignTradeSetup } from "@/lib/trading/classification/service";
...
export async function PUT(
  ...
  try {
    ...
    const setup = await assignTradeSetup(id, body as Parameters<typeof assignTradeSetup>[1]);
