/**
 * Calendar Domain — Error State Component
 *
 * Rendered when calendar data fetching fails.
 */
...
export function CalendarErrorState({ message, onRetry }: CalendarErrorStateProps) {
  return (
    ...
    >
      ...
      <h3 className="text-sm font-semibold text-rose-200">Unable to Load Calendar</h3>
