/**
 * Reports Domain — Error State Component
 */
...
export function ReportsErrorState({ message, onRetry }: ReportsErrorStateProps) {
  return (
    <div
      className="rounded-xl border border-rose-900/40 bg-rose-950/20 p-8 flex flex-col items-center justify-center text-center shadow-sm max-w-md mx-auto my-6"
    ...
    >
      ...
      <h3 className="text-sm font-semibold text-rose-200">Unable to Load Reports</h3>
